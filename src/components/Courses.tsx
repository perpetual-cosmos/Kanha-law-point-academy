    ...
    <section className="py-24 bg-slate-50 relative" id="courses">
      <div className="max-w-container-max mx-auto px-4 md:px-8 space-y-12">
        ...
        <div className="bg-navy-950 text-white rounded-2xl border border-gold-500/40 overflow-hidden shadow-navy-glow relative group transition-all duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 relative z-10">
            ...
            <div className="lg:col-span-5 p-8 md:p-10 bg-gradient-to-b from-navy-900 via-navy-950 to-slate-950 border-b lg:border-b-0 lg:border-r border-gold-500/30 flex flex-col justify-between space-y-6">
              <div>
                <span className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-gold-500/20 text-gold-300 text-xs font-bold uppercase tracking-wider mb-5 border border-gold-500/40 shadow-sm">
                ...
                <ul className="space-y-3 font-sans text-sm text-slate-200">
                  <li className="flex items-center space-x-3 bg-navy-900/80 p-3 rounded-lg border border-gold-500/20 shadow-subtle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* CLAT-UG Card */}
          <div className="card-top-accent bg-card-gradient p-8 rounded-2xl border border-slate-200/90 shadow-card hover:shadow-card-hover hover:border-gold-500/40 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between space-y-6 group">
            <div>
            ...
            <a
              href="#contact"
              className="text-xs font-bold text-navy-950 hover:text-gold-600 flex items-center space-x-1.5 pt-2"
            >
        ...
        <div className="card-top-accent bg-gradient-to-r from-navy-950 via-navy-900 to-slate-900 text-white p-8 rounded-2xl border border-gold-500/40 shadow-navy-glow flex flex-col md:flex-row justify-between items-center gap-6 group hover:border-gold-400 transition-all duration-300">
          <div>
